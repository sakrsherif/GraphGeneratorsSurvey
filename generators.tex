...
In this section we explore in more detail different graph data generators using the classification introduced before. For each category we briefly describe key features of each of the representatives. The aim is to provide the readers with a detailed look at each of the tools in the context of its competitors from the same domain.
