...
generators or tools to flexibly and holistically generate multi-domain graphs  in a flexible and holistic manner, allowing to configure aspects
...
multi-model systems are in the context of Big Data are rather new, there exist only
