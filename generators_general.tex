...
\paragraph{Graph 500 Benchmark} \texttt{The Graph 500 Benchmark}~\cite{Graph500} includes
...
\paragraph{Darwini} \texttt{Darwini}~\cite{edunov2016darwini} is an extension of \texttt{BTER}
