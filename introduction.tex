...
Generation of networks tackling Kronecker
recursion with recursive tensor multiplication \cite{AkogluMF08} is then considered in the above survey.
We refer the reader to the aformentioned survey for evolutionary network generators and further discuss the open challenges of evolving graph data in Section 5.
