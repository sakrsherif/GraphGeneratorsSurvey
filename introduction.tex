...
To conclude the comparative study, we discuss open challenges and missing features of graph generators in view of identifying future challenges in data science.
