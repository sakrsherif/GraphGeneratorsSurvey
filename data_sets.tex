...
Besides graph data generators, many graph algorithms and systems are benchmarked using real graph data sets, including new graph data generation techniques. In this section, we review the most widely used graph datasets in the literature and their purpose.
